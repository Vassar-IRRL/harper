...
[![Documentation](https://img.shields.io/badge/docs-GitHub%20Pages-green)](https://vassar-irrl.github.io/harper/)

This repository hosts the open-source hardware and software artifacts from the HARPER Project. The documentation for the project is hosted at [vassar-irrl.github.io/harper](https://vassar-irrl.github.io/harper/).
...
| [`docs/`](docs/) | Docusaurus site source: builds the project documentation hosted at [vassar-irrl.github.io/harper](https://vassar-irrl.github.io/harper/). |
...
|----------|---------|------|
| Software and documentation | [Apache License, Version 2.0](LICENSE) | [`LICENSE`](LICENSE) |
| Hardware designs (print files, mechanical designs) | [CERN Open Hardware Licence Version 2 – Strongly Reciprocal (CERN-OHL-S)](harper_print_files/LICENSE) | [`harper_print_files/LICENSE`](harper_print_files/LICENSE) |
